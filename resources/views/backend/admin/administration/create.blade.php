...
<div class="page-content">
    ...
    <div class="card">
        <div class="card-body">
            <h4 class="card-title mb-4">Add New Administration Member</h4>
                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <small class="text-muted">e.g., "Academic Director", "Student Affairs Manager"</small>
                                    </div>
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <select class="form-control" id="department" name="department">
                                            ...
                                            <option value="HR & Administration" {{ old('department') == 'HR & Administration' ? 'selected' : '' }}>HR & Administration</option>
                                            <option value="Registrar Office" {{ old('department') == 'Registrar Office' ? 'selected' : '' }}>Registrar Office</option>
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="number" class="form-control" id="years_of_service" name="years_of_service" 
                                               value="{{ old('years_of_service') }}" min="0" max="50">
                                    </div>
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <small class="text-muted">e.g., "Main Building, Room 205"</small>
                                    </div>
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <small class="text-muted">e.g., "Mon-Fri 9:00 AM - 5:00 PM"</small>
                                    </div>
                                    
                                    <div class="col-12 mb-3">
                                        <label for="bio" class="form-label">Biography</label>
                                        <textarea class="form-control" id="bio" name="bio" rows="4">{{ old('bio') }}</textarea>
                                        <small class="text-muted">Professional background and responsibilities</small>
                                    </div>
                                </div>
                            </div>
                        </div>
