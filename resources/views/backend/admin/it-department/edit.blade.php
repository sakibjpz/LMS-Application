...
<div class="page-content">
    ...
    <div class="card">
        <div class="card-body">
            <h4 class="card-title mb-4">Edit IT Department Member</h4>
            
            <form action="{{ route('admin.it-department.update', $itDepartment->id) }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                    ...
                    <div class="col-lg-8">
                                ...
                                <div class="row">
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="text" class="form-control" id="name" name="name" 
                                               value="{{ old('name', $itDepartment->name) }}" required>
                                    </div>
                                    
                                    <div class="col-md-6 mb-3">
                                        <label for="position" class="form-label">Position *</label>
                                        <input type="text" class="form-control" id="position" name="position" 
                                               value="{{ old('position', $itDepartment->position) }}" required>
                                    </div>
                                    
                                    <div class="col-md-6 mb-3">
                                        <label for="email" class="form-label">Email Address</label>
                                        <input type="email" class="form-control" id="email" name="email" 
                                               value="{{ old('email', $itDepartment->email) }}">
                                    </div>
                                    
                                    <div class="col-md-6 mb-3">
                                        <label for="phone" class="form-label">Phone Number</label>
                                        <input type="text" class="form-control" id="phone" name="phone" 
                                               value="{{ old('phone', $itDepartment->phone) }}">
                                    </div>
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="text" class="form-control" id="expertise" name="expertise" 
                                               value="{{ old('expertise', $itDepartment->expertise) }}">
                                    </div>
                                    
                                    <div class="col-md-6 mb-3">
                                        <label for="experience_years" class="form-label">Years of Experience</label>
                                        <input type="number" class="form-control" id="experience_years" name="experience_years" 
                                               value="{{ old('experience_years', $itDepartment->experience_years) }}" min="0" max="50">
                                    </div>
                                    
                                    <div class="col-12 mb-3">
                                        <label for="bio" class="form-label">Biography</label>
                                        <textarea class="form-control" id="bio" name="bio" rows="4">{{ old('bio', $itDepartment->bio) }}</textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card shadow-sm mb-4">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    @php
                                        $socialLinks = $itDepartment->social_links ?? [];
                                    @endphp
                            ...
                            <div class="card-body text-center">
                                <div class="mb-3">
                                    @if($itDepartment->photo)
                                        <img src="{{ asset('storage/' . $itDepartment->photo) }}" 
                            ...
                            <div class="card-body">
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control" id="display_order" name="display_order" 
                                           value="{{ old('display_order', $itDepartment->display_order) }}" min="0">
                                </div>
                                
                                <div class="form-check form-switch">
                                    <input class="form-check-input" type="checkbox" role="switch" 
                                           id="is_active" name="is_active" value="1"
                                           {{ $itDepartment->is_active ? 'checked' : '' }}>
