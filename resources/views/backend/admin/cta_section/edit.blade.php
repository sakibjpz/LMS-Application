...
<div class="page-content">
    <div class="row">
        <div class="col-md-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    <h6 class="card-title">Edit CTA Section</h6>
                    
                    <form action="{{ route('admin.cta-section.update', $ctaSection->id) }}" method="POST">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="ribbon_text" name="ribbon_text" 
                                   value="{{ old('ribbon_text', $ctaSection->ribbon_text) }}"
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" id="main_text" name="main_text" rows="4" 
                                      placeholder="Enter your call-to-action text here..." required>{{ old('main_text', $ctaSection->main_text) }}</textarea>
                            @error('main_text')
                                <div class="text-danger">{{ $message }}</div>
                            @enderror
                        </div>
